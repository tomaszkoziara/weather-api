...
import { WindspeedAPI, IWindspeedAPI } from '../src/service/windspeed/WindspeedAPI';
...
describe('WindspeedAPI', () => {
    ...
    beforeEach(() => {
        ...
        fetchMock
            .mock('http://localhost:8000?at=2018-07-10T00%3A00%3A00Z', JSON.stringify({
    ...
    describe('fetchWindspeed', () => {
        ...
        it('should respond with windspeed data and date if called with correct date', async () => {
            ...
            const temperature = await windspeedAPI.fetchWindspeed('2018-07-10T13:00:00Z');
